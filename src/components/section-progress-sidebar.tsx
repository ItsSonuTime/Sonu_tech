...
export default function SectionProgressSidebar() {
  ...
  const handleScroll = useCallback(() => {
    ...
    const isNearFooter = footerElement ? 
      scrollY + windowHeight > footerElement.getBoundingClientRect().top + windowHeight * 0.2 : 
      scrollY + windowHeight > documentHeight - windowHeight * 0.3

    // Show sidebar after scrolling past hero section and hide when near footer
    setIsVisible(scrollY > windowHeight * 0.3 && !isNearFooter)
